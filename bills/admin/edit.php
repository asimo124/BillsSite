    ...
    <form class="form-horizontal" id="frmEditBill" action="proc_edit.php?<?= $searchFilersQueryStr ?>" method="post" >
        <fieldset>
            ...
            <div class="form-group value_orig" >
                ...
                <div class="col-md-4">
                    <input id="vnd_frequency_value_original" name="vnd_frequency_value_original" type="text" placeholder="Frequency Value (Month Day, Start Date) - actual day" class="form-control input-md" value="<?php echo $Bill['vnd_frequency_value_original']; ?>" />
                </div>
            </div>
            <div class="form-group">
