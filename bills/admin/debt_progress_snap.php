...
$sql = "SELECT * FROM dp_snapshot WHERE id = :id";
$items = getQuery($sql, [
    "id" => $id
]);
$item = null;
...
<div class="container">
    ...
    <h2>Debt Progress Snapshot From <?php echo date("Y-m-d", strtotime($item['entrydate'])); ?></h2>

    <div style="clear: both; height: 12px"></div>

    <?php include "../../templates/nav.php"; ?>

    <form class="form-horizontal" id="frmEditBill" action="" method="post" >
        <fieldset>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="stage1_start_date" name="stage1_start_date" value="<?= $item['stage1_start_date']; ?>" type="text" placeholder="Starting Point"
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="stage1_remaining_balance" name="stage1_remaining_balance" value="<?= $item['stage1_remaining_balance']; ?>"  type="
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="stage1_min_payment_principal1" name="stage1_min_payment_principal1" value="<?= $item['stage1_min_payment_principal1']; ?>"
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="stage1_mom_principal" name="stage1_mom_principal" value="<?= $item['stage1_mom_principal']; ?>" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="stage1_me_principal" name="stage1_me_principal" value="<?= $item['stage1_me_principal']; ?>"  type="text"
    ...
    <form class="form-horizontal" id="frmEditBill" action="" method="post" >
        <fieldset>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="textinput">Remaining Balance</label>
                <div class="col-md-4">
                    <input id="stage2_remaining_balance" name="stage2_remaining_balance" value="<?= $item['stage2_remaining_balance']; ?>" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="stage2_min_payment_principal1" name="stage2_min_payment_principal1" value="<?= $item['stage2_min_payment_principal1']; ?>" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="stage2_min_payment_principal2" name="stage2_min_payment_principal2" value="<?= $item['stage2_min_payment_principal2']; ?>" type="text"
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="textinput">How much does Mom pay to principal every month?</label>
                <div class="col-md-4">
                    <input id="stage2_mom_principal" name="stage2_mom_principal" value="<?= $item['stage2_mom_principal']; ?>" type="text"
                           placeholder="Mom pays to principal monthly" class="form-control input-md input-blur" value="" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label" for="textinput">How much does I pay to principal every month?</label>
                <div class="col-md-4">
                    <input id="stage2_me_principal" name="stage2_me_principal" value="<?= $item['stage2_me_principal']; ?>" type="text"
                           placeholder="I pay to principal monthly" class="form-control input-md input-blur" value="" />
                </div>
            </div>
            <div class="form-group">
    ...
    <form class="form-horizontal" id="frmEditBill" action="" method="post" >
        <fieldset>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="textinput">Starting Point</label>
                <div class="col-md-4">
                    <input id="stage3_start_date" name="stage3_start_date" value="<?= $item['stage3_start_date']; ?>"
                           type="text" placeholder="Starting Point" class="form-control input-md" value="" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label" for="textinput">Remaining Balance</label>
                <div class="col-md-4">
                    <input id="stage3_remaining_balance" name="stage3_remaining_balance" value="<?= $item['stage3_remaining_balance']; ?>" type="text" placeholder="Remaining Balance" class="form-control input-md" value="" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label" for="textinput">How much of min payment goes to principal?</label>
                <div class="col-md-4">
                    <input id="stage3_min_payment_principal1" name="stage3_min_payment_principal1" value="<?= $item['stage3_min_payment_principal1']; ?>" type="text" placeholder="Min payment goes to principal" class="form-control input-md" value="" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label" for="textinput">How much does Mom pay to principal every month?</label>
                <div class="col-md-4">
                    <input id="stage3_mom_principal" name="stage3_mom_principal" value="<?= $item['stage3_mom_principal']; ?>" type="text" placeholder="Mom pays to principal monthly" class="form-control input-md" value="" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label" for="textinput">How much does I pay to principal every month?</label>
                <div class="col-md-4">
                    <input id="stage3_me_principal" name="stage3_me_principal" value="<?= $item['stage3_me_principal']; ?>" type="text" placeholder="I pay to principal monthly" class="form-control input-md" value="" />
                </div>
            </div>
