    ...
    <form class="form-horizontal" id="frmEditBill" action="proc_edit.php?<?= $searchFilersQueryStr ?>" method="post" >
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="original_debt_owed" name="original_debt_owed" type="number" placeholder="Original Debt Owed" class="form-control input-md" value="<?php echo isset($Loan['original_debt_owed']) ? $Loan['original_debt_owed'] : ''; ?>" />
                </div>
            </div>
            <div class="form-group">
