...
$fh = fopen("swift_data_files/models_old_layout.txt", 'r');
...
foreach ($responseArr3 as $modelClass => $getItem) {
	...
	foreach ($getItem as $method => $field) {
		...
		$file_name = "swift_data_files/old_fields_layout2.txt";
...
/*$table_file_name = "swift_data_files/" . "old_table_fields.json";
$fh4 = fopen($table_file_name, 'w');
fwrite($fh4, json_encode($responseArr4));
fclose($fh4);

$table_file_name = "swift_data_files/" . "old_model_fields.json";
$fh5 = fopen($table_file_name, 'w');
fwrite($fh5, json_encode($responseArr5));
fclose($fh5);*/

$table_file_name = "swift_data_files/" . "old_modeldata_fields.json";
