...
//
//  TblAnimalDataOtherWeight.swift
//  IOSApp3
//
...
class TblAnimalDataOtherWeightData {
	...
	func setHeight(height: Int?) {
        ...
        let height2 = height ?? 0
        self.height_str = String(height2)
        self.height_str = (self.height_str == "0") ? "" : self.height_str
    }
    func getHeight() -> Int {
        return self.height
    }
    ...
    func loadByID(animal_registration: String) -> [String: String] {
        let qb = QueryBuilder()
        qb.selectFrom("tbl_animal_data_other_weight")
        ...
        if (error != nil) {
            ...
            if resultset.count > 0 {
				...
				self.setHeight((row["height"]?.asInt()));
    ...
    func addNew() {
        ...
        var statement = "INSERT INTO tbl_animal_data_other_weight ("
        var i = 0
        let obj = self
        let reflected = Mirror(reflecting: obj)
        for child in reflected.children {
    ...
    func update(forID: String) {
        ...
        var statement = "UPDATE tbl_animal_data_other_weight "
        var i = 0
        let obj = self
        let reflected = Mirror(reflecting: obj)
        for child in reflected.children {
    ...
    func delete(forID: Int) {
        let query = "DELETE FROM tbl_animal_data_other_weight WHERE animal_registration = " + String(forID)
        let dbn = DatabaseOld()
        dbn.query(query)
    }
    ...
    func deletePG(forID: String) {
        ...
        let statement = "DELETE FROM tbl_animal_data_other_weight WHERE animal_registration = " + String(forID)
        let dbn = DatabaseOld()
        dbn.query("INSERT INTO " + SyncableQueries.TABLE_NAME
            + " (" + SyncableQueries.SQL_QUERY + ") "
            + " VALUES "
    ...
    class func getLastanimalRegistration() -> String {
        ...
        let query = "SELECT animal_registration from tbl_animal_data_other_weight ORDER BY _id DESC LIMIT 1 "
