...
class TblMemberTransfersData {
	...
	var transfer_value: Double = -1.0
    var transfer_value_str: String = "unset"
	...
	func setTransferValue(transfer_value: Double?) {
   	   self.transfer_value = transfer_value ?? 0.0
   	   self.transfer_value_str = String(self.transfer_value)
    }
    func getTransferValue() -> Double {
        return self.transfer_value
    }
    func getTransferValueType() -> String {
        return "Double"
    };
	func getTransferValueStr() -> String {
        return transfer_value_str
    };
	func getTransferValueStrPG() -> String {
        return transfer_value_str
    };
	...
	func getFieldString(field: String) -> String {
        switch field { 
			...
			case "transfer_value":
			return self.getTransferValueStr()
			case "animal_registration":
    ...
    func loadByID(member_id: String) -> [String: String] {
        let qb = QueryBuilder()
        qb.selectFrom("tbl_member_transfers")
            .Where("member_id = ?")
        ...
        if (error != nil) {
            ...
            if resultset.count > 0 {
				...
				self.setTransferValue((row["transfer_value"]?.asDouble()));
				...
				fields["transfer_value"] = self.getTransferValueStr()
    ...
    func getFieldsPG() -> [String: String] {
		...
		fields["transfer_value"] = self.getTransferValueStrPG()
    ...
    func addNew() {
        ...
        var statement = "INSERT INTO tbl_member_transfers ("
        var i = 0
        let obj = self
        let reflected = Mirror(reflecting: obj)
        for child in reflected.children {
    ...
    func update(forID: String) {
        ...
        var statement = "UPDATE tbl_member_transfers "
        var i = 0
        let obj = self
        let reflected = Mirror(reflecting: obj)
        for child in reflected.children {
    ...
    func delete(forID: Int) {
        let query = "DELETE FROM tbl_member_transfers WHERE member_id = " + String(forID)
        let dbn = DatabaseOld()
        dbn.query(query)
    }
    ...
    func deletePG(forID: String) {
        ...
        let statement = "DELETE FROM tbl_member_transfers WHERE member_id = " + String(forID)
        let dbn = DatabaseOld()
        dbn.query("INSERT INTO " + SyncableQueries.TABLE_NAME
            + " (" + SyncableQueries.SQL_QUERY + ") "
            + " VALUES "
    ...
    class func getLastmemberId() -> String {
        ...
        let query = "SELECT member_id from tbl_member_transfers ORDER BY _id DESC LIMIT 1 "
