...
class TblAnimalDataYearData {
	...
	var year_weight: Double = -1.0
    var year_weight_str: String = "unset"
	...
	var year_weight_adj: Double = -1.0
    var year_weight_adj_str: String = "unset"
	...
	var stage_code: String = "unset"
    var stage_code_str: String = "unset"
	...
	var yw_ratio: Double = -1.0
    var yw_ratio_str: String = "unset"
	var premise_id: String = "unset"
    var premise_id_str: String = "unset"
	var pasture_id: String = "unset"
    var pasture_id_str: String = "unset"
	var yearling_age_range: String = "unset"
    var yearling_age_range_str: String = "unset"
	...
	var avg_daily_gain: Double = -1.0
    var avg_daily_gain_str: String = "unset"
	...
	var post_weaning_gain: Double = -1.0
    var post_weaning_gain_str: String = "unset"
	...
	func setYearWeight(year_weight: Double?) {
   	   self.year_weight = year_weight ?? 0.0
   	   self.year_weight_str = String(self.year_weight)
    }
    func getYearWeight() -> Double {
        return self.year_weight
    }
    func getYearWeightType() -> String {
        return "Double"
    };
	func getYearWeightStr() -> String {
        return year_weight_str
    };
	func getYearWeightStrPG() -> String {
        return year_weight_str
    };
	...
	func setYearWeightAdj(year_weight_adj: Double?) {
   	   self.year_weight_adj = year_weight_adj ?? 0.0
   	   self.year_weight_adj_str = String(self.year_weight_adj)
    }
    func getYearWeightAdj() -> Double {
        return self.year_weight_adj
    }
    func getYearWeightAdjType() -> String {
        return "Double"
    };
	func getYearWeightAdjStr() -> String {
        return year_weight_adj_str
    };
	func getYearWeightAdjStrPG() -> String {
        return year_weight_adj_str
    };
	...
	func setStageCode(stage_code: String?) {
        self.stage_code = stage_code ?? ""
        self.stage_code_str = String(self.stage_code)
    }
    func getStageCode() -> String {
        return self.stage_code
    }
    func getStageCodeType() -> String {
        return "String"
    };
	func getStageCodeStr() -> String {
        return stage_code_str == "unset" ? "" : stage_code_str
    };
	func getStageCodeStrPG() -> String {
        return stage_code_str == "unset" ? "" : stage_code_str
    };
	...
	func setYwRatio(yw_ratio: Double?) {
   	   self.yw_ratio = yw_ratio ?? 0.0
   	   self.yw_ratio_str = String(self.yw_ratio)
    }
    func getYwRatio() -> Double {
        return self.yw_ratio
    }
    func getYwRatioType() -> String {
        return "Double"
    };
	func getYwRatioStr() -> String {
        return yw_ratio_str
    };
	func getYwRatioStrPG() -> String {
        return yw_ratio_str
    };
	...
	func setYearlingAgeRange(yearling_age_range: String?) {
        self.yearling_age_range = yearling_age_range ?? ""
        self.yearling_age_range_str = String(self.yearling_age_range)
    }
    func getYearlingAgeRange() -> String {
        return self.yearling_age_range
    }
    func getYearlingAgeRangeType() -> String {
        return "String"
    };
	func getYearlingAgeRangeStr() -> String {
        return yearling_age_range_str == "unset" ? "" : yearling_age_range_str
    };
	func getYearlingAgeRangeStrPG() -> String {
        return yearling_age_range_str == "unset" ? "" : yearling_age_range_str
    };
	...
	func setAvgDailyGain(avg_daily_gain: Double?) {
   	   self.avg_daily_gain = avg_daily_gain ?? 0.0
   	   self.avg_daily_gain_str = String(self.avg_daily_gain)
    }
    func getAvgDailyGain() -> Double {
        return self.avg_daily_gain
    }
    func getAvgDailyGainType() -> String {
        return "Double"
    };
	func getAvgDailyGainStr() -> String {
        return avg_daily_gain_str
    };
	func getAvgDailyGainStrPG() -> String {
        return avg_daily_gain_str
    };
	...
	func setPostWeaningGain(post_weaning_gain: Double?) {
   	   self.post_weaning_gain = post_weaning_gain ?? 0.0
   	   self.post_weaning_gain_str = String(self.post_weaning_gain)
    }
    func getPostWeaningGain() -> Double {
        return self.post_weaning_gain
    }
    func getPostWeaningGainType() -> String {
        return "Double"
    };
	func getPostWeaningGainStr() -> String {
        return post_weaning_gain_str
    };
	func getPostWeaningGainStrPG() -> String {
        return post_weaning_gain_str
    };
	...
	func getFieldString(field: String) -> String {
        switch field { 
			...
			case "yw_ratio":
			return self.getYwRatioStr()
			case "premise_id":
			return self.getPremiseIdStr()
			case "pasture_id":
			return self.getPastureIdStr()
			case "yearling_age_range":
			return self.getYearlingAgeRangeStr()
			case "scrotal_circumference":
			...
			case "avg_daily_gain":
			return self.getAvgDailyGainStr()
			case "frame_score":
			...
			case "post_weaning_gain":
			return self.getPostWeaningGainStr()
			default:
    ...
    func loadByID(animal_registration: String) -> [String: String] {
        let qb = QueryBuilder()
        qb.selectFrom("tbl_animal_data_year")
        ...
        if (error != nil) {
            ...
            if resultset.count > 0 {
				...
				self.setYearWeight((row["year_weight"]?.asDouble()));
				...
				self.setYwRatio((row["yw_ratio"]?.asDouble()));
				self.setPremiseId((row["premise_id"]?.asString()));
				self.setPastureId((row["pasture_id"]?.asString()));
				self.setYearlingAgeRange((row["yearling_age_range"]?.asString()));
				...
				self.setAvgDailyGain((row["avg_daily_gain"]?.asDouble()));
				...
				fields["yw_ratio"] = self.getYwRatioStr()
				fields["premise_id"] = self.getPremiseIdStr()
				fields["pasture_id"] = self.getPastureIdStr()
				fields["yearling_age_range"] = self.getYearlingAgeRangeStr()
				...
				fields["avg_daily_gain"] = self.getAvgDailyGainStr()
				...
				fields["post_weaning_gain"] = self.getPostWeaningGainStr()
    ...
    func getFieldsPG() -> [String: String] {
		...
		fields["year_weight"] = self.getYearWeightStrPG()
		...
		fields["yw_ratio"] = self.getYwRatioStrPG()
		fields["premise_id"] = self.getPremiseIdStrPG()
		fields["pasture_id"] = self.getPastureIdStrPG()
		fields["yearling_age_range"] = self.getYearlingAgeRangeStrPG()
		...
		fields["avg_daily_gain"] = self.getAvgDailyGainStrPG()
		...
		fields["post_weaning_gain"] = self.getPostWeaningGainStrPG()
		return fields    }

    func addNew() {

        var statement = "INSERT INTO tbl_animal_data_year ("
        var i = 0
        let obj = self
        let reflected = Mirror(reflecting: obj)
        for child in reflected.children {
    ...
    func update(forID: String) {
        ...
        var statement = "UPDATE tbl_animal_data_year "
        var i = 0
        let obj = self
        let reflected = Mirror(reflecting: obj)
        for child in reflected.children {
    ...
    func delete(forID: Int) {
        let query = "DELETE FROM tbl_animal_data_year WHERE animal_registration = " + String(forID)
        let dbn = DatabaseOld()
        dbn.query(query)
    }
    ...
    func deletePG(forID: String) {
        ...
        let statement = "DELETE FROM tbl_animal_data_year WHERE animal_registration = " + String(forID)
        let dbn = DatabaseOld()
        dbn.query("INSERT INTO " + SyncableQueries.TABLE_NAME
            + " (" + SyncableQueries.SQL_QUERY + ") "
            + " VALUES "
    ...
    class func getLastanimalRegistration() -> String {
        ...
        let query = "SELECT animal_registration from tbl_animal_data_year ORDER BY _id DESC LIMIT 1 "
