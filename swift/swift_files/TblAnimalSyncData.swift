...
class TblAnimalSyncData {
	...
	var sync_date: NSDate = NSDate.distantFuture() as NSDate
    var sync_date_str: String = "unset"
	...
	func setSyncDate(sync_date: NSDate?) {
        self.sync_date = sync_date ?? NSDate.distantPast() as NSDate
        self.sync_date_str = Utils.dateToString(self.sync_date)
    }
    func getSyncDate() -> NSDate {
        return self.sync_date
    }
    func getSyncDateType() -> String {
        return "NSDate"
    };
	func getSyncDateStr() -> String {
        return sync_date_str == "unset" || sync_date_str == "0000-12-30 00:00:00 +0000" ? "" : sync_date_str
    };
	func getSyncDateStrPG() -> String {
        return sync_date_str == "unset" || sync_date_str == "0000-12-30 00:00:00 +0000" ? "" : sync_date_str
    };
    ...
    func loadByID(animal_registration: String) -> [String: String] {
        ...
        if (error != nil) {
            ...
            if resultset.count > 0 {
				...
				self.setSyncDate((row["sync_date"]?.asDate()));
				...
				fields["sync_date"] = self.getSyncDateStr()
    ...
    func getFieldsPG() -> [String: String] {
		...
		fields["sync_date"] = self.getSyncDateStrPG()
    ...
    func addNew() {
        ...
        var statement = "INSERT INTO tbl_animal_sync ("
        var i = 0
        let obj = self
        let reflected = Mirror(reflecting: obj)
        for child in reflected.children {
    ...
    func update(forID: String) {
        ...
        var statement = "UPDATE tbl_animal_sync "
        var i = 0
        let obj = self
        let reflected = Mirror(reflecting: obj)
        for child in reflected.children {
    ...
    func delete(forID: Int) {
        let query = "DELETE FROM tbl_animal_sync WHERE animal_registration = " + String(forID)
        let dbn = DatabaseOld()
        dbn.query(query)
    }
    ...
    func deletePG(forID: String) {
        ...
        let statement = "DELETE FROM tbl_animal_sync WHERE animal_registration = " + String(forID)
        let dbn = DatabaseOld()
        dbn.query("INSERT INTO " + SyncableQueries.TABLE_NAME
            + " (" + SyncableQueries.SQL_QUERY + ") "
            + " VALUES "
    ...
    class func getLastanimalRegistration() -> String {
        ...
        let query = "SELECT animal_registration from tbl_animal_sync ORDER BY _id DESC LIMIT 1 "
