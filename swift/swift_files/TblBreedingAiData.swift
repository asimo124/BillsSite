...
class TblBreedingAiData {

	var breeding_ai_id: Int = -1
    var breeding_ai_id_str: String = "unset"
	...
	func setBreedingAiId(breeding_ai_id: Int?) {
        self.breeding_ai_id = breeding_ai_id ?? 0
        let breeding_ai_id2 = breeding_ai_id ?? 0
        self.breeding_ai_id_str = String(breeding_ai_id2)
        self.breeding_ai_id_str = (self.breeding_ai_id_str == "0") ? "" : self.breeding_ai_id_str
    }
    func getBreedingAiId() -> Int {
        return self.breeding_ai_id
    }
    func getBreedingAiIdType() -> String {
        return "Int"
    };
	func getBreedingAiIdStr() -> String {
        return breeding_ai_id_str
    };
	func getBreedingAiIdStrPG() -> String {
        return breeding_ai_id_str
    };
	...
	func getFieldString(field: String) -> String {
        switch field { 
			case "breeding_ai_id":
			return self.getBreedingAiIdStr()
			case "cow_owner_id":
    ...
    func loadByID(bull_registration: String) -> [String: String] {
        ...
        if (error != nil) {
            ...
            if resultset.count > 0 {
				...
				self.setBreedingAiId((row["breeding_ai_id"]?.asInt()));
				...
				var fields = [String: String]()
				fields["breeding_ai_id"] = self.getBreedingAiIdStr()
    ...
    func getFieldsPG() -> [String: String] {
		...
		fields["breeding_ai_id"] = self.getBreedingAiIdStrPG()
    ...
    func addNew() {
        ...
        var statement = "INSERT INTO tbl_breeding_ai ("
        var i = 0
        let obj = self
        let reflected = Mirror(reflecting: obj)
        for child in reflected.children {
    ...
    func update(forID: String) {
        ...
        var statement = "UPDATE tbl_breeding_ai "
        var i = 0
        let obj = self
        let reflected = Mirror(reflecting: obj)
        for child in reflected.children {
    ...
    func delete(forID: Int) {
        let query = "DELETE FROM tbl_breeding_ai WHERE bull_registration = " + String(forID)
        let dbn = DatabaseOld()
        dbn.query(query)
    }
    ...
    func deletePG(forID: String) {
        ...
        let statement = "DELETE FROM tbl_breeding_ai WHERE bull_registration = " + String(forID)
        let dbn = DatabaseOld()
        dbn.query("INSERT INTO " + SyncableQueries.TABLE_NAME
            + " (" + SyncableQueries.SQL_QUERY + ") "
            + " VALUES "
    ...
    class func getLastbullRegistration() -> String {
        ...
        let query = "SELECT bull_registration from tbl_breeding_ai ORDER BY _id DESC LIMIT 1 "
